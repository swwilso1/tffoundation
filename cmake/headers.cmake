...
CHECK_INCLUDE_FILE(arpa/inet.h HAS_ARPA_INET_H)
CHECK_INCLUDE_FILE(asm/tpyes.h HAS_ASM_TYPES_H)
CHECK_INCLUDE_FILE(dlfcn.h HAS_DLFCN_H)
CHECK_INCLUDE_FILE(fcntl.h HAS_FCNTL_H)
CHECK_INCLUDE_FILE(iphlpapi.h HAS_IPHLPAPI_H)
CHECK_INCLUDE_FILE(linux/netlink.h HAS_LINUX_NETLINK_H)
CHECK_INCLUDE_FILE(linux/rtnetlink.h HAS_LINUX_RTNETLINK_H)
CHECK_INCLUDE_FILE(linux/wireless.h HAS_LINUX_WIRELESS_H)
CHECK_INCLUDE_FILE(net/if.h HAS_NET_IF_H)
CHECK_INCLUDE_FILE(net/if_dl.h HAS_NET_IF_DL_H)
CHECK_INCLUDE_FILE(net/if_types.h HAS_NET_IF_TYPES_H)
CHECK_INCLUDE_FILE(net/route.h HAS_NET_ROUTE_H)
CHECK_INCLUDE_FILE(netdb.h HAS_NETDB_H)
CHECK_INCLUDE_FILE(netinet/in.h HAS_NETINET_IN_H)
CHECK_INCLUDE_FILE(poll.h HAS_POLL_H)
CHECK_INCLUDE_FILE(pthread.h HAS_PTHREAD_H)
CHECK_INCLUDE_FILE(sys/file.h HAS_SYS_FILE_H)
CHECK_INCLUDE_FILE(sys/ioctl.h HAS_SYS_IOCTL_H)
CHECK_INCLUDE_FILE(sys/resource.h HAS_SYS_RESOURCE_H)
CHECK_INCLUDE_FILE(sys/select.h HAS_SYS_SELECT_H)
CHECK_INCLUDE_FILE(sys/sendfile.h HAS_SYS_SENDFILE_H)
CHECK_INCLUDE_FILE(sys/socket.h HAS_SYS_SOCKET_H)
CHECK_INCLUDE_FILE(sys/sysctl.h HAS_SYS_SYSCTL_H)
CHECK_INCLUDE_FILE(sys/sysinfo.h HAS_SYS_SYSINFO_H)
CHECK_INCLUDE_FILE(sys/time.h HAS_SYS_TIME_H)
CHECK_INCLUDE_FILE(sys/types.h HAS_SYS_TYPES_H)
CHECK_INCLUDE_FILE(sys/uio.h HAS_SYS_UIO_H)
CHECK_INCLUDE_FILE(sys/wait.h HAS_SYS_WAIT_H)
CHECK_INCLUDE_FILE(unistd.h HAS_UNISTD_H)
CHECK_INCLUDE_FILE(winsock2.h HAS_WINSOCK2_H)
CHECK_INCLUDE_FILE(ws2tcpip.h HAS_WS2TCPIP_H)
